...
{
 "use strict";
 var WebSharper,UI,Templating,Runtime,Server,TemplateInitializer,Obj,TemplateInstances,Handler,ProviderBuilder,TemplateInstance,Client,Collections,Dictionary,IntelliFactory,Runtime$1,Arrays,Var$1,Operators,Doc,Client$1,Templates,Slice,BindVar,View,console,Activator,HashSet,Enumerator,Seq,System,Guid;
